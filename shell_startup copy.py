            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                """if mc.checkForInput(OPTIONS_MOUSE_POS):
                    ...
                    if options.highres==True:
                        import easygui 
                        easygui.msgbox("https://www.123pan.com/s/q4jSVv-v3EU3.html提取码:1145","https://www.123pan.com/s/q4jSVv-v3EU3.html提取码:1145")
                        easygui.msgbox("覆盖textures目录即可","覆盖textures目录即可")
