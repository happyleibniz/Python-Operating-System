...
class DestroyBlock:
    ...
    def loadTextures(self):
        ...
        for e, i in enumerate(os.listdir("minecraft_python_edition/textures/blocks/block_destroy")):
            self.textures[e] = \
                pyglet.graphics.TextureGroup(pyglet.image.load("minecraft_python_edition/textures/blocks/block_destroy/" + i)
