...
from minecraft_python_edition.functions import *
from minecraft_python_edition.game.Lighting.Light import Light
from minecraft_python_edition.game.Particles import Particles
from minecraft_python_edition.game.blocks.DestroyBlock import DestroyBlock
from minecraft_python_edition.game.blocks.droppedBlock import droppedBlock
from minecraft_python_edition.game.entity.Inventory import Inventory
from minecraft_python_edition.game.entity.Zombie import Zombie
from minecraft_python_edition.game.world.Clouds import Clouds
from minecraft_python_edition.game.world.worldGenerator import worldGenerator
from minecraft_python_edition.game.blocks.CubeHandler import CubeHandler
...
class Scene:
    ...
    def loadPanoramaTextures(self):
        ...
        for e, i in enumerate(os.listdir("minecraft_python_edition/gui/bg/")):
            self.panorama[e] = \
                pyglet.graphics.TextureGroup(pyglet.image.load("minecraft_python_edition/gui/bg/" + i).get_mipmapped_texture())
