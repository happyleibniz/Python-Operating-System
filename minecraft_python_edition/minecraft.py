...
from minecraft_python_edition.functions import drawInfoLabel, getElpsTime, translateSeed
from minecraft_python_edition.game.GUI.Button import Button
from minecraft_python_edition.game.GUI.Editarea import Editarea
from minecraft_python_edition.game.GUI.GUI import GUI
from minecraft_python_edition.game.GUI.Sliderbox import Sliderbox
from minecraft_python_edition.game.entity.Player import Player
from minecraft_python_edition.game.sound.BlockSound import BlockSound
from minecraft_python_edition.game.sound.Sound import Sound
from minecraft_python_edition.game.Scene import Scene
from minecraft_python_edition.game.world.Biomes import getBiomeByTemp
from minecraft_python_edition.game.world.worldGenerator import worldGenerator
from minecraft_python_edition.settings import *
...
logo = pyglet.resource.image("minecraft_python_edition/gui/logo.png")
...
sound.BLOCKS_SOUND["pickUp"] = pygame.mixer.Sound("minecraft_python_edition/sounds/pick.mp3")

print("Loading step sounds...")
sound.BLOCKS_SOUND["step"] = {}
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/step/")):
    ...
    sound.BLOCKS_SOUND["step"][soundName].append(pygame.mixer.Sound("minecraft_python_edition/sounds/step/" + i))
    print("Successful loaded", soundName, "#" + soundNum, "sound!")

print("Loading dig sounds...")
sound.BLOCKS_SOUND["dig"] = {}
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/dig/")):
    soundName = i.split(".")[0][:-1]
    soundNum = i.split(".")[0][-1]
    ...
    sound.BLOCKS_SOUND["dig"][soundName].append(pygame.mixer.Sound("minecraft_python_edition/sounds/dig/" + i))
    print("Successful loaded", soundName, "#" + soundNum, "sound!")

print("Loading explode sounds...")
sound.BLOCKS_SOUND["explode"] = []
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/explode/")):
    soundName = i.split(".")[0][:-1]
    soundNum = i.split(".")[0][-1]

    sound.BLOCKS_SOUND["explode"].append(pygame.mixer.Sound("minecraft_python_edition/sounds/explode/" + i))
    print("Successful loaded", soundName, "#" + soundNum, "sound!")

print("Loading damage sounds...")
sound.SOUNDS["damage"] = {}
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/damage/")):
    soundName = i.split(".")[0][:-1]
    soundNum = i.split(".")[0][-1]
    ...
    sound.SOUNDS["damage"][soundName].append(pygame.mixer.Sound("minecraft_python_edition/sounds/damage/" + i))
    print("Successful loaded", soundName, "#" + soundNum, "sound!")

print("Loading GUI sounds...")
sound.SOUNDS["GUI"] = {}
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/gui/")):
    soundName = i.split(".")[0][:-1]
    soundNum = i.split(".")[0][-1]
    ...
    sound.SOUNDS["GUI"][soundName].append(pygame.mixer.Sound("minecraft_python_edition/sounds/gui/" + i))
    print("Successful loaded", soundName, "#" + soundNum, "sound!")

print("Loading menu music...")
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/music/menu")):
    sound.MENU_MUSIC.append("minecraft_python_edition/sounds/music/menu/" + i)
    print("Successful loaded", i, "music!")

print("Loading game music...")
for e, i in enumerate(os.listdir("minecraft_python_edition/sounds/music/game")):
    sound.MUSIC.append("minecraft_python_edition/sounds/music/game/" + i)
    print("Successful loaded", i, "music!")
sound.initMusic(False)
...
gui.GUI_TEXTURES = {
    "crafting_table": pyglet.resource.image("minecraft_python_edition/gui/crafting_table.png"),
    "inventory_window": pyglet.resource.image("minecraft_python_edition/gui/inventory_window.png"),
    "crosshair": pyglet.resource.image("minecraft_python_edition/gui/crosshair.png"),
    "inventory": pyglet.resource.image("minecraft_python_edition/gui/inventory.png"),
    "sel_inventory": pyglet.resource.image("minecraft_python_edition/gui/sel_inventory.png"),
    "fullheart": pyglet.resource.image("minecraft_python_edition/gui/fullheart.png"),
    "halfheart": pyglet.resource.image("minecraft_python_edition/gui/halfheart.png"),
    "heartbg": pyglet.resource.image("minecraft_python_edition/gui/heartbg.png"),
    "game_logo": pyglet.resource.image("minecraft_python_edition/gui/game_logo.png"),
    "button_bg": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/button_bg.png"),
    "button_bg_hover": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/button_bg_hover.png"),
    "edit_bg": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/edit_bg.png"),
    "options_background": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/options_background.png"),
    "black": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/black.png"),
    "red": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/red.png"),
    "selected": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/selected.png"),
    "slider": pyglet.resource.image("minecraft_python_edition/gui/gui_elements/slider.png"),
}
...
splfile = open("minecraft_python_edition/gui/splashes.txt", "r")
