...
sys.is_pythonos_doc_run = True

document_modules = ["pythonos"]
...
.. |min_python_version_package_name| replace:: ``python3.8``
.. |min_python_version_fancy_str| replace:: Python 3.8\+
"""
...
build_data = (("Date", now.strftime("%Y/%m/%d %H:%M:%S")),
              ("pythonOS version", "1.0.2024.5.28"))
...
project = "python operating system"
copyright = "2023-2024, LiuJiaXuan HuangShaoQi"
...
modindex_common_prefix = ["pythonos."]
...
html_title = f"pythonOS v1.2024.5.28"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = f"pythonOS v1.2024.5.28 documentation "
...
latex_documents = [
  ("index", "PythonOS", "PythonOS Documentation",
   "Liu Jia Xuan, Huang Shap Qi", "manual"),
]
...
texinfo_documents = [
  ("index", "PythonOS", "PythonOS Documentation",
   "Liu Jia Xuan, Huang Shap Qi", "manual", "PythonOS", "One line description of project.",
   "Miscellaneous"),
]
