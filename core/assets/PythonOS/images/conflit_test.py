...
glShaderSource(
    vertex_shader, 1, ctypes.byref(ctypes.c_char_p(vertex_shader_code_bytes)), None
)
...
glShaderSource(
    fragment_shader, 1, ctypes.byref(ctypes.c_char_p(fragment_shader_code_bytes)), None
)
...
vertex_list = pyglet.graphics.vertex_list(
    4, ("v2f", vertices), ("t2f", (0, 0, 1, 0, 0, 1, 1, 1))
)
